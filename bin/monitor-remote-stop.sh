...
echo "`scp $PROJECT_CLOUD/bin/stop-monitor.sh opennebula@$VM_IP:/home/opennebula`" >>  $PROJECT_CLOUD/logs/sys.log
echo "`ssh opennebula@$VM_IP 'bash -i' /home/opennebula/stop-monitor.sh `" >> $PROJECT_CLOUD/logs/sys.log
done
